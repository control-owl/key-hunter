...
- Target address: 1LeBZP5QCwwgXRtmVUvTVrraqPUokyLHqe
...
- ~~GPU solver (CUDA-based, very fast on NVIDIA GPUs)~~
- ~~Combined CPU + GPU mode~~
- **Live dashboard** showing per-thread~~/GPU~~ progress, speed, current key
